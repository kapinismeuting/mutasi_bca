...
# ===== CONFIGURATION =====
PDF_FOLDER = os.path.expanduser("~/dev/appdev/Mutasi/2026")
OUTPUT_FOLDER = os.path.expanduser("~/dev/appdev/Mutasi_By_Year")
# =========================
...
def process_all_pdfs_to_single_excel(pdf_folder: str, output_folder: str) -> None:
    ...
    os.makedirs(output_folder, exist_ok=True)
    output_path = os.path.join(output_folder, "Mutasi 2026.xlsx")
    ...
    for filename in pdf_files:
        ...
        try:
            ...
            # 🧠 Sheet name from filename (JAN, FEB, etc)
            sheet_name = os.path.splitext(filename)[0][:3].upper()
            ...
            print(f"  ✅ Sheet '{sheet_name}' added ({len(transactions)} rows)")
...
if __name__ == "__main__":
    process_all_pdfs_to_single_excel(PDF_FOLDER, OUTPUT_FOLDER)